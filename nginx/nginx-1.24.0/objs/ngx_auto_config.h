#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-http_ssl_module --with-openssl=/root/4119/openssl-3.4.1 --with-openssl-opt='enable-engine enable-sm2 enable-sm3 enable-sm4 enable-ec enable-ktls no-asm'"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 7.3.0 (GCC) "
#endif
